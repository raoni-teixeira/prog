...
#caixa(
  ...
  [
    ...
    1. declarar   variáveis com tipos adequados ao problema; 
    2. identificar e corrigir erros de  divisão inteira e overflow; 
    3. usar casting explícito quando necessário;
