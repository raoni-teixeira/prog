...
#block(
  ...
  \
  #text(fill: rgb("#aaccee"), size: 12pt)[Aula 5 – Repetição]
  \
  #v(4pt)
...
#caixa(
  ...
  [
    ...
    1. Aplicar as três perguntas de um laço (o que se repete, quantas vezes,
       o que muda) para planejar a estrutura de while, do-while e for;
    2. Implementar os padrões de acumulação e contagem dentro de laços;
    3. Identificar e corrigir um loop infinito causado pela ausência do
       avanço na variável de controle;
    4. Explicar a equivalência entre for e while e escolher a forma mais
       legível para cada situação.
  ],
)
