...
#block(
  ...
  *Objetivos:* ao final deste laboratório, a dupla deve ser capaz de: (1) combinar
  condições com `&&`, `||` e `!`; (2) usar `switch` corretamente, com atenção ao
  `break`; (3) identificar e corrigir fall-through indesejado; (4) aplicar os
  quatro pilares da legibilidade na revisão de código alheio.
]
